...
//   motor_flag= RoadIsZebra( Bin_Image,can); //斑马线

    if(motor_flag==1)
    {

//        Pid_Value();
//    MotorDuty1 = (sint16)PidIncCtrl(&LSpeed_PID, (float)(targetspeedL - encoder_L)); // 速度闭环
//    MotorDuty2 = (sint16)PidIncCtrl(&RSpeed_PID, (float)(targetspeedR- encoder_R)); // 速度闭环
//    if (MotorDuty1 > 9999)
//            MotorDuty1 = 9999;
...
//                        pwm_set_duty(ATOM1_CH7_P02_7,0);
                        MotorDuty1 =0;
                        MotorDuty2=0;
//        MotorDuty1 = (sint16)PidIncCtrl(&LSpeed_PID, (float)(0 - encoder_L)); // 速度闭环
//
//        MotorDuty2 = (sint16)PidIncCtrl(&RSpeed_PID, (float)(0- encoder_R)); // 速度闭环
//        if (MotorDuty1 > 9999)
//                    MotorDuty1 = 9999;
//            else if (MotorDuty1 < -9999)
//                    MotorDuty1 = 9999;
